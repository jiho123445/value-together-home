      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <div className="space-y-2">
            <p className="text-xs font-bold text-primary-ink tracking-wide">NEWS</p>
            <h2 className="font-display font-black text-2xl sm:text-3xl text-ink">최근소식</h2>
          </div>
          <button type="button" onClick={() => setActiveTab('news')} className="inline-flex items-center gap-1.5 text-sm font-bold text-ink-soft hover:text-ink">
