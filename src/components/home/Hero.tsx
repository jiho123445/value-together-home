    ...
    <section className="relative bg-paper overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-14 pb-16 sm:pt-20 sm:pb-24 relative grid lg:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          <span className="inline-flex items-center gap-1.5 text-xs font-bold text-secondary-ink bg-secondary-soft px-3.5 py-1.5 rounded-full">
            <HeartHandshake className="w-3.5 h-3.5" />
            사회적협동조합 가치함께
          </span>
          <h1 className="font-display font-black text-3xl sm:text-4xl lg:text-[2.75rem] leading-[1.25] text-ink text-balance">
            {settings.sloganMain}
          </h1>
          <p className="text-ink-soft text-sm sm:text-base leading-relaxed max-w-lg">{settings.sloganSub}</p>
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white border border-line text-ink font-bold text-sm hover:border-primary transition-colors"
            >
              함께하는 방법 보기
            </button>
          </div>
