      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-10">
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <div className="space-y-2">
            <p className="text-xs font-bold text-primary-ink tracking-wide">OUR BUSINESS</p>
            <h2 className="font-display font-black text-2xl sm:text-3xl text-ink">주요사업</h2>
          </div>
          <button type="button" onClick={() => setActiveTab('business')} className="inline-flex items-center gap-1.5 text-sm font-bold text-ink-soft hover:text-ink">
          ...
          {list.map((program) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <span className="text-[11px] font-bold text-secondary-ink bg-secondary-soft px-2.5 py-1 rounded-full">{program.category}</span>
                </div>
