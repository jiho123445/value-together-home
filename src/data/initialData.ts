...
export const INITIAL_SETTINGS: OrgSettings = {
  ...
  representativeTitle: '조합장',
  representativeName: '홍길동',
  representativeImageUrl: undefined,
  representativeGreeting:
    '함께하는 마음이 지역사회의 변화를 만듭니다.\n\n' +
    '안녕하십니까. 사회적협동조합 가치함께 조합장입니다.\n\n' +
    '가치함께는 사람을 중심에 두고, 이웃과 지역사회가 함께 성장할 수 있는 길을 만들어가기 위해 설립되었습니다. 저희는 화려한 성과보다 꾸준한 실천을, 일회성 행사보다 오래 이어지는 관계를 더 소중하게 생각합니다.\n\n' +
    '작은 방문 하나, 짧은 교육 한 시간, 따뜻한 관심과 한마디의 응원이 누군가에게는 다시 일어설 수 있는 힘이 될 수 있다는 믿음으로 한 걸음씩 사업을 이어가고 있습니다.\n\n' +
    '우리가 꿈꾸는 변화는 거창한 곳에서 시작되지 않습니다. 한 사람을 살피는 마음에서 시작되어, 이웃과 함께하는 작은 실천을 통해 지역사회 전체의 변화로 이어진다고 믿습니다.\n\n' +
    '가치함께는 생애주기별 교육과 지역공동체 활성화, 통합돌봄, 자립기반 일자리 지원 등 지역주민의 삶과 가까운 다양한 사업을 통해 누구도 소외되지 않고 함께 살아가는 지역사회를 만들어가겠습니다.\n\n' +
    '앞으로도 조합원 여러분의 소중한 의견에 귀 기울이고 지역사회의 목소리를 세심하게 담아내겠습니다. 또한 투명하고 민주적인 운영과 책임 있는 실천을 바탕으로, 조합원에게는 신뢰받고 지역사회에는 꼭 필요한 사회적협동조합으로 성장하겠습니다.\n\n' +
    '사람과 사람을 잇고, 이웃과 지역사회를 잇는 것 — 그것이 가치함께가 걸어가고자 하는 길입니다.\n\n' +
    '조합원 여러분과 지역주민 여러분의 따뜻한 관심과 참여가 가치함께의 가장 큰 힘입니다. 앞으로도 함께해 주시기를 부탁드립니다. 감사합니다.',
  logoUrl: undefined,
  ...
  introStatement:
    '사람의 삶을 중심에 두고, 필요한 지원을 함께 연결합니다.\n\n' +
    '가치함께는 사회서비스, 교육, 지역사회, 돌봄·복지, 일자리·자립지원 등 다양한 영역의 사업을 유기적으로 연결하여 지역주민의 삶을 지원하는 사회적협동조합입니다.\n\n' +
    '한 사람의 삶에는 돌봄, 교육, 경제적 어려움, 일자리와 같은 여러 문제가 서로 연결되어 나타나는 경우가 많습니다. 가치함께는 이러한 현실을 바라보며 각각의 사업을 따로 운영하기보다, 사람에게 필요한 지원이 서로 연결될 수 있는 통합적인 지원체계를 만들어가고자 합니다.\n\n' +
    '이를 위해 조합원과 이용자, 자원봉사자, 지역의 다양한 기관과 단체가 서로의 경험과 자원을 나누고 협력할 수 있는 지역사회 협력의 플랫폼이 되고자 합니다.\n\n' +
    '가치함께는 한 사람의 작은 변화가 가족과 이웃의 변화로, 그리고 지역사회의 변화로 이어질 수 있다고 믿습니다.\n\n' +
    '사람을 중심에 두고, 이웃과 함께하고, 지역사회와 함께 성장하는 것 — 그것이 가치함께가 추구하는 협동의 가치입니다.\n\n' +
    '앞으로도 지역사회의 목소리에 귀 기울이며, 누구나 존중받고 함께 살아갈 수 있는 지속가능한 지역사회를 만들어가는 사회적협동조합으로 성장하겠습니다.',
