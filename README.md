...
## 디자인 고도화 v1.1
- Hero를 Full-Width 실사 배경으로 개선했습니다.
- CI와 한글 typography를 확대했습니다.
- 주요사업 카드와 함께하는 방법 섹션을 보강했습니다.
- 초기 검토용 이미지 출처는 `IMAGE_SOURCES.md`에 기록했습니다.
- 최종 운영 전 이미지 라이선스 및 자체 저장소 이전을 재확인하세요.
